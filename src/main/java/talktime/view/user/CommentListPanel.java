 ...
 * @author Gopal
 */
public class CommentListPanel extends javax.swing.JPanel {
public String tId;
public int intTid;
public int panelGap;
JPanel panel;
    /**
     * Creates new form CommentListPanel
     */
    public CommentListPanel(String message,String tId) {
        initComponents();
        this.tId=tId;
   ...
   public void show(){
        try{
            ...
            String sql ="SELECT * FROM comments where  thread_id = ?";
            String[] para={tId};
            ...
            while (rs.next()) {
                ...
                String title = rs.getString("comment_content");
                //String desc = rs.getString("thread_desc");
                String userid = String.valueOf(rs.getInt("comment_by"));
                ...
                questionPanel.setPreferredSize(new Dimension(850,60));
                questionPanel.setMinimumSize(new Dimension(850,60));
                questionPanel.setMaximumSize(new Dimension(850,60));
                ...
                JLabel userLabel = new JLabel("Commented by: " + userEmail + " at " + time);
